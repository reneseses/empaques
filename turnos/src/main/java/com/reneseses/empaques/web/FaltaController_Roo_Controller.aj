...
privileged aspect FaltaController_Roo_Controller {
    ...
    public String FaltaController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
